...
// const loginForms = document.getElementById("login-form1");
// const loginButtons = document.getElementById("login-form-submit1");
// const loginErrorMsgs = document.getElementById("login-error-msg1");
// const loginForm2 = document.getElementById("login-form2");
// const loginButton2 = document.getElementById("login-form-submit2");
...
//     e.preventDefault();
//     const username = loginForms.usernam.value;
//     const password = loginForms.passwor.value;

//     if (username === "user1" && password === "web_dev1") {
//         alert("You have successfully logged in.");
//         location.reload();
//     } else {
//         loginErrorMsgs.style.opacity = 1;
//     }
// });
...
//     if (username === "user2" && password === "web_dev2") {
//         alert("You have successfully logged in.");
//         location.reload();
//     } else {
...
// var newTeach = document.getElementById("subj1").value;
// console.log(subj1);
...
var subTeach = [
    ...
    "Biology"];
function myFunction() {
    let newTeach = document.getElementById("subj1")
    document.getElementById("teach").innerHTML = newTeach;
    subTeach.push(newTeach.value)
    document.getElementById("tutor").innerHTML = subTeach;
...
// var subTeach = ["Basic Tech", "Basic Sci", "French", "Biology"];
// function myFunction() {
//     let newTeach = document.getElementById("subj1")
//     document.getElementById("teach").innerHTML = newTeach;
//     subTeach.push(newTeach.value)
...
// var nwTeach = document.getElementById("subj2").value;
// console.log(subj2);
// document.getElementById("teach").innerHTML = newTeach;
//  console.log(newTeach);
...
//         "BOOK KEEPING",
//     ];
//     var newTeach = document.getElementById("subj1")
//     // var newTeach = document.getElementById("subj2");
//     console.log(newTeach.value);
// function myFunction() {
    
// document.getElementById("subj1").innerHTML = newTeach;
//     console.log(subTeach)
//     subTeach.push(newTeach.value)
//     document.getElementById("tutor").innerHTML = subTeach;
//     console.log(subTeach)
...
// Get the modal
var modal = document.getElementById('signall');
...
var getin = document.getElementById('main-holder');
